...
ods _all_ close;
ods htmlcss file='C:\REB\AARP_HRTandMelanoma\Results\misc\T1\Table1.v6.xls' style=minimal;
proc tabulate data=use missing;
	title1 'AARP-Baseline, Table 1';
	title2 'melanoma in situ and malignant';
	title3 '20150701WED WTL';
	class melanoma_c
		agecat attained_age birth_cohort
		educ_c bmi_c physic_c  
		fmenstr menostat_c meno_age_c surg_age_c
		parity flb_age_c oralbc_dur_c horm_nat_c  
		horm_surg_c uvrq marriage
