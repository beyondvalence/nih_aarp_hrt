...
LIBNAME Results 'E:\NCI\HRT OC and BCC in USRT\Results\HRT';
...
variable="Null_Model_HRT_EVER";
run;

*** Demographics ***;

proc phreg data = use;
class hrt_evr_me  (ref='1') BIRTH_COHORT (ref='1');
...
proc phreg data = use;
class hrt_evr_me  (ref='1') education;
model exit_age*EVENT_BCC(0)=hrt_evr_me education/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') cohabit;
model exit_age*EVENT_BCC(0)=hrt_evr_me cohabit/ entry = entry_age RL; 
ods output ParameterEstimates=cohabit;
run;
data cohabit; set cohabit;
if Parameter='hrt_evr_me';
variable="cohabit";
run;
...
proc phreg data = use;
class hrt_evr_me  (ref='1') BMI_CAT (ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me BMI_CAT/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') ;
model exit_age*EVENT_BCC(0)=hrt_evr_me LQ2_BMI/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') ;
model exit_age*EVENT_BCC(0)=hrt_evr_me LQ2_HEIGHT/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') LQ2_SMK_EVER (ref='0');
model exit_age*EVENT_BCC(0)=hrt_evr_me LQ2_SMK_EVER/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') alcohol  (ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me alcohol/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') exercize (ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me exercize/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') ex_stren (ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me ex_stren/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') selfhealth (ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me selfhealth/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') LQ2_Q67_DIURETICS (ref='0');
model exit_age*EVENT_BCC(0)=hrt_evr_me LQ2_Q67_DIURETICS/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') eye (ref='3') ;
model exit_age*EVENT_BCC(0)=hrt_evr_me eye/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') LQ2_Q70_1716 (ref='3');
model exit_age*EVENT_BCC(0)=hrt_evr_me LQ2_Q70_1716/ entry = entry_age RL;
...
proc phreg data = use;
class hrt_evr_me  (ref='1') hair (ref='3');
model exit_age*EVENT_BCC(0)=hrt_evr_me hair/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') LQ2_Q81_1803 (ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me LQ2_Q81_1803/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') Hispanic (ref='1') ;
model exit_age*EVENT_BCC(0)=hrt_evr_me Hispanic/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') UVTOMS305q (ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me UVTOMS305q/ entry = entry_age RL; 
ods output ParameterEstimates=UV;
run;
data UV; set UV;
if Parameter='hrt_evr_me';
variable="UVTOMS305q";
...
proc phreg data = use;
class hrt_evr_me  (ref='1') hndoseq  (ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me hndoseq/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') LQ2_MENO_EVER(ref='0') ;
model exit_age*EVENT_BCC(0)=hrt_evr_me LQ2_MENO_EVER/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') ;
model exit_age*EVENT_BCC(0)=hrt_evr_me numpreg/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') ;
model exit_age*EVENT_BCC(0)=hrt_evr_me LQ2_BRTH_NUM/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') ;
model exit_age*EVENT_BCC(0)=hrt_evr_me oc_evr_c/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') ;
model exit_age*EVENT_BCC(0)=hrt_evr_me LQ2_Q34_707/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') meno_age(ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me meno_age/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') ;
model exit_age*EVENT_BCC(0)=hrt_evr_me LQ2_Q36_710/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') hyster(ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me hyster/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') natmeno(ref='1');
model exit_age*EVENT_BCC(0)=hrt_evr_me natmeno/ entry = entry_age RL; 
...
proc phreg data = use;
class hrt_evr_me  (ref='1') ovaries(ref='3');
model exit_age*EVENT_BCC(0)=hrt_evr_me ovaries/ entry = entry_age RL; 
...
set 
crude birthcohort education cohabit
bmi_cat bmi_cont lq2_height smoking alcohol 
exercize ex_stren selfhealth diuretics
eye skin hair celtic Hispanic
hndoseq UV
LQ2_MENO_EVER numpreg LQ2_BRTH_NUM oc_evr_c menarche_age 
menoage_cat menoage_cont hysterectomy natmeno ovaries
; run;
data confounder1_testing; 
set confounder1_testing
(Keep= variable HazardRatio HRLowerCL HRUpperCL); Parameter=log(HazardRatio);run;
ods html file='E:\NCI\HRT OC and BCC in USRT\Results\HRT\confounder1_testing.xls' style=minimal;
...
model exit_age*EVENT_BCC(0)=hrt_evr_me BIRTH_COHORT UVTOMS305q/ entry = entry_age RL; 
ods output ParameterEstimates=null;
run;
data null; set null;
if Parameter='hrt_evr_me';
variable="null_model_Bc_UV";
run;
