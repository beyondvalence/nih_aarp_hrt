...
proc phreg data = use;
	...
	model exit_age*melanoma_ins(0)= horm_ever_me birth_cohort_me uvrq_me educ_c_me / entry = entry_age RL; 
...
data confounder2_base_ins_oralbc; 
	set 
		null birthcohort_me education horm_ever_me 
		bmi_c_me flb_age_c_me etoh_c_me smoke_former_me uvrq_me
		rel_1d_cancer_me; 
run;
data confounder2_base_ins_oralbc; 
