...
** with marriage, family history of cancer, colo_sig_any
...
** uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry
...
proc phreg data = use multipass;
	class  flb_age_c_me (ref='< 20 years old') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_ins(0)=flb_age_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  flb_age_c_me (ref='< 20 years old') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_mal(0)=flb_age_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
	ods output ParameterEstimates=A_flb NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  parity_me (ref='1-2 live children') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_ins(0)=parity_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  parity_me (ref='1-2 live children') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_mal(0)=parity_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
	ods output ParameterEstimates=A_parity NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  fmenstr_me (ref='<=10') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_ins(0)=fmenstr_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  fmenstr_me (ref='<=10') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_mal(0)=fmenstr_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
	ods output ParameterEstimates=A_fmenstr NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  oralbc_dur_c_me (ref='never/<1yr') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_ins(0)=oralbc_dur_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  oralbc_dur_c_me (ref='never/<1yr') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_mal(0)=oralbc_dur_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
	ods output ParameterEstimates=A_oralbc NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  menostat_c_me (ref='natural menopause') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') menop_age (ref='<40') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_ins(0)=menostat_c_me uvrq educ_c bmi_c smoke_former menop_age rel_1d_cancer marriage colo_sig_any / entry = entry_age RL;
...
proc phreg data = use multipass;
	class  menostat_c_me (ref='natural menopause') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') menop_age (ref='<40') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_mal(0)=menostat_c_me uvrq educ_c bmi_c smoke_former menop_age rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
	ods output ParameterEstimates=A_menostat NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  meno_age_c_me (ref='50-54') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_ins(0)=meno_age_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  meno_age_c_me (ref='50-54') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_mal(0)=meno_age_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
	ods output ParameterEstimates=A_menoage NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  surg_age_c_me (ref='45-49') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_ins(0)=surg_age_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  surg_age_c_me (ref='45-49') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_mal(0)=surg_age_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
	ods output ParameterEstimates=A_surgage NObs = obs;
run;
...
** overall (surgural + surgical menopause);
proc phreg data = use multipass;
	class  oralbc_yn_c_me (ref='never/<1yr') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_ins(0)=oralbc_yn_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  oralbc_yn_c_me (ref='never/<1yr') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') colo_sig_any (ref='No');
	model exit_age*melanoma_mal(0)=oralbc_yn_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage colo_sig_any / entry = entry_age RL; 
	ods output ParameterEstimates=A_oralbcyn NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use_r multipass;
	class  menostat_c_me (ref='natural menopause') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') menop_age (ref='1') colo_sig_any (ref='No');
	model exit_age*melanoma_ins(0)=menostat_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage menop_age colo_sig_any / entry = entry_age RL; 
	ods output ParameterEstimates=A_menostat NObs = obs;
run;
...
proc phreg data = use_r multipass;
	class  menostat_c_me (ref='natural menopause') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') menop_age (ref='1') colo_sig_any (ref='No');
	model exit_age*melanoma_mal(0)=menostat_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage menop_age colo_sig_any / entry = entry_age RL; 
	ods output ParameterEstimates=A_menostat NObs = obs;
run;
...
proc phreg data = use_r multipass;
	class  menostat_c_me (ref='natural menopause') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') rel_1d_cancer (ref='No') marriage (ref='married') menop_age (ref='1') colo_sig_any (ref='No');
	model exit_age*melanoma_mal(0)=menostat_c_me uvrq educ_c bmi_c smoke_former rel_1d_cancer marriage menop_agecolo_sig_any / entry = entry_age RL; 
	where menostat_c=2;
	ods output ParameterEstimates=A_menostat_SR NObs = obs;
run;
data A_menostat_SR; 
