...
** melanoma: _ins, 
** variables: ME+uvrq+educ_c+bmi_c+smoke_former+parity+fmenstr;
** uvrq educ_c bmi_c smoke_former parity fmenstr / entry
...
proc phreg data = use multipass;
	class  flb_age_c_me (ref='< 20 years old') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=flb_age_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  flb_age_c_me (ref='< 20 years old') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=flb_age_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_flb NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  horm_ever_me (ref='never') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=horm_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  horm_ever_me (ref='never') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=horm_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_horm NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  parity_me (ref='1-2 live children') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=parity_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  parity_me (ref='1-2 live children') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=parity_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_parity NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  fmenstr_me (ref='<=10') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=fmenstr_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  fmenstr_me (ref='<=10') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=fmenstr_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_fmenstr NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  oralbc_dur_c_me (ref='never/<1yr') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=oralbc_dur_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  oralbc_dur_c_me (ref='never/<1yr') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=oralbc_dur_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_oralbc NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  menostat_c_me (ref='natural menopause') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=menostat_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  menostat_c_me (ref='natural menopause') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=menostat_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_menostat NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  meno_age_c_me (ref='50-54') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=meno_age_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  meno_age_c_me (ref='50-54') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=meno_age_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_menoage NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  surg_age_c_me (ref='50-54') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=surg_age_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  surg_age_c_me (ref='50-54') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=surg_age_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_surgage NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  horm_nat_ever_me (ref='never') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=horm_nat_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  horm_nat_ever_me (ref='never') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=horm_nat_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_hormnatvr NObs = obs;
run;
...
proc phreg data = use multipass;
	class  horm_surg_ever_me (ref='never') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=horm_surg_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  horm_surg_ever_me (ref='never') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=horm_surg_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_hormsurgvr NObs = obs;
run;
...
** overall (surgural + surgical menopause);
proc phreg data = use multipass;
	class  oralbc_yn_c_me (ref='never/<1yr') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=oralbc_yn_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  oralbc_yn_c_me (ref='never/<1yr') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=oralbc_yn_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_oralbcyn NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use multipass;
	class  ovarystat_c_me (ref='both removed') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=ovarystat_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use multipass;
	class  ovarystat_c_me (ref='both removed') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=ovarystat_c_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_ovaryst NObs = obs;
run;
...
ods html file='C:\REB\AARP_HRTandMelanoma\Results\baseline\master\modelD\base_model_D.xls' style=minimal;
...
proc phreg data = use_r multipass;
	class  lacey_eptcurrent_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=lacey_eptcurrent_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  lacey_eptcurrent_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=lacey_eptcurrent_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_eptcur NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use_r multipass;
	class  lacey_eptdur_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=lacey_eptdur_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  lacey_eptdur_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=lacey_eptdur_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_eptdur NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use_r multipass;
	class  lacey_eptdose_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=lacey_eptdose_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  lacey_eptdose_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=lacey_eptdose_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_eptdose NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use_r multipass;
	class  lacey_etcurrent_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=lacey_etcurrent_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  lacey_etcurrent_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=lacey_etcurrent_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_etcur NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use_r multipass;
	class  lacey_etdur_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=lacey_etdur_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  lacey_etdur_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=lacey_etdur_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_etdur NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use_r multipass;
	class  lacey_etdose_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=lacey_etdose_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  lacey_etdose_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=lacey_etdose_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_etdose NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use_r multipass;
	class  ht_type_nat_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=ht_type_nat_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  ht_type_nat_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=ht_type_nat_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_htnat NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use_r multipass;
	class  ht_type_surg_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=ht_type_surg_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  ht_type_surg_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=ht_type_surg_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_htsurg NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use_r multipass;
	class  lacey_etfreq_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=lacey_etfreq_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  lacey_etfreq_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=lacey_etfreq_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_etfreq NObs = obs;
run;
...
** overall (surgural + surgical menopause);
proc phreg data = use_r multipass;
	class  lacey_eptcurrent_ever_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=lacey_eptcurrent_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  lacey_eptcurrent_ever_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=lacey_eptcurrent_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_eptcurvr NObs = obs;
run;
...
** overall (surgural + surgical menopause);
proc phreg data = use_r multipass;
	class  lacey_etcurrent_ever_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=lacey_etcurrent_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  lacey_etcurrent_ever_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=lacey_etcurrent_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_etcurvr NObs = obs;
run;
...
** overall (surgural + surgical menopause);
proc phreg data = use_r multipass;
	class  ht_type_nat_ever_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=ht_type_nat_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  ht_type_nat_ever_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=ht_type_nat_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_htnatvr NObs = obs;
run;
...
** overall (natural + surgical menopause);
proc phreg data = use_r multipass;
	class  ht_type_surg_ever_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_ins(0)=ht_type_surg_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
...
proc phreg data = use_r multipass;
	class  ht_type_surg_ever_me (ref='No HT') uvrq (ref='0 to 186.918') educ_c (ref='less than highschool') bmi_c (ref='< 25') smoke_former (ref='never smoked') parity (ref='1-2 live children') fmenstr (ref='<=10');
	model exit_age*melanoma_mal(0)=ht_type_surg_ever_me uvrq educ_c bmi_c smoke_former parity fmenstr / entry = entry_age RL; 
	ods output ParameterEstimates=A_htsurgvr NObs = obs;
run;
...
ods html file='C:\REB\AARP_HRTandMelanoma\Results\rfq\master\modelD\risk_model_D.xls' style=minimal;
