...
run;
********************************************************************************;
** fmenstr_me, age at menarche in situ **;
********************************************************************************;
** crude **;
proc phreg data = use;
	title 'crude model - fmenstr, in situ, base';
...
** birth cohort;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') birth_cohort_me (ref='1925-1928');
...
** education;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') educ_c_me (ref='highschool or less');
...
** bmi;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') bmi_c_me (ref='18.5 to < 25');
...
** physcial activity;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') physic_c_me (ref='rarely');
...
** parity;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') parity_me (ref='nulliparous');
...
** hormever;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') horm_ever_me (ref='never');
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') flb_age_c_me (ref='< 20 years old');
...
** oral bc duration;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') oralbc_dur_c_me (ref='none');
...
** UVR quartiles;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') uvrq_me (ref='0 to 186.918');
...
** smoking status;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') smoke_former_me (ref='never smoked');
...
** coffee drinking;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') coffee_c_me (ref='none');
...
** etoh drinking;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') etoh_c_me (ref='none');
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') rel_1d_cancer_me (ref='No');
...
** marriage;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') marriage (ref='married');
	model exit_age*melanoma_ins(0)=fmenstr_me marriage/ entry = entry_age RL; 
...
data confounder1_base_ins_fmenstr; 
	set 
		crude birthcohort
		education bmi_c_me physic_c_me 
		parity_me flb_age_c_me horm_ever_me
		oralbc_dur_c_me uvrq_me smoke_former_me coffee_c_me 
		etoh_c_me rel_1d_cancer_me marriage; 
run;
data confounder1_base_ins_fmenstr; 
	set confounder1_base_ins_fmenstr
		(Keep= variable HazardRatio HRLowerCL HRUpperCL); 
		Parameter=log(HazardRatio);
run;
ods html file='C:\REB\AARP_HRTandMelanoma\Results\modelBuilding\confounder1_base_ins_fmenstr.xls' style=minimal;
proc print data= confounder1_base_ins_fmenstr; run;
ods _all_ close;ods html;

********************************************************************************;
** fmenstr_me, age at menarche malignant **;
********************************************************************************;
** crude **;
proc phreg data = use;
	title 'crude model - fmenstr, malignant, base';
	class fmenstr_me  (ref='<=10') ;
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') birth_cohort_me (ref='1925-1928');
	model exit_age*melanoma_mal(0)=fmenstr_me birth_cohort_me/ entry = entry_age RL; 
	ods output ParameterEstimates=birthcohort;
run;
data birthcohort; set birthcohort;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') educ_c_me (ref='highschool or less');
	model exit_age*melanoma_mal(0)=fmenstr_me educ_c_me/ entry = entry_age RL; 
	ods output ParameterEstimates=education;
run;
data education; set education;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') bmi_c_me (ref='18.5 to < 25');
	model exit_age*melanoma_mal(0)=fmenstr_me bmi_c_me/ entry = entry_age RL; 
	ods output ParameterEstimates=bmi_c_me;
run;
data bmi_c_me; set bmi_c_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') physic_c_me (ref='rarely');
	model exit_age*melanoma_mal(0)=fmenstr_me physic_c_me/ entry = entry_age RL; 
	ods output ParameterEstimates=physic_c_me;
run;
data physic_c_me; set physic_c_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') parity_me (ref='nulliparous');
	model exit_age*melanoma_mal(0)=fmenstr_me parity_me/ entry = entry_age RL; 
	ods output ParameterEstimates=parity_me;
run;
data parity_me; set parity_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') horm_ever_me (ref='never');
	model exit_age*melanoma_mal(0)=fmenstr_me horm_ever_me/ entry = entry_age RL; 
	ods output ParameterEstimates=horm_ever_me;
run;
data horm_ever_me; set horm_ever_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') flb_age_c_me (ref='< 20 years old');
	model exit_age*melanoma_mal(0)=fmenstr_me flb_age_c_me/ entry = entry_age RL; 
	ods output ParameterEstimates=flb_age_c_me;
run;
data flb_age_c_me; set flb_age_c_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') oralbc_dur_c_me (ref='none');
	model exit_age*melanoma_mal(0)=fmenstr_me oralbc_dur_c_me/ entry = entry_age RL; 
	ods output ParameterEstimates=oralbc_dur_c_me;
run;
data oralbc_dur_c_me; set oralbc_dur_c_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') uvrq_me (ref='0 to 186.918');
	model exit_age*melanoma_mal(0)=fmenstr_me uvrq_me/ entry = entry_age RL; 
	ods output ParameterEstimates=uvrq_me;
run;
data uvrq_me; set uvrq_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') smoke_former_me (ref='never smoked');
	model exit_age*melanoma_mal(0)=fmenstr_me smoke_former_me/ entry = entry_age RL; 
	ods output ParameterEstimates=smoke_former_me;
run;
data smoke_former_me; set smoke_former_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') coffee_c_me (ref='none');
	model exit_age*melanoma_mal(0)=fmenstr_me coffee_c_me/ entry = entry_age RL; 
	ods output ParameterEstimates=coffee_c_me;
run;
data coffee_c_me; set coffee_c_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') etoh_c_me (ref='none');
	model exit_age*melanoma_mal(0)=fmenstr_me etoh_c_me/ entry = entry_age RL; 
	ods output ParameterEstimates=etoh_c_me;
run;
data etoh_c_me; set etoh_c_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') rel_1d_cancer_me (ref='No');
	model exit_age*melanoma_mal(0)=fmenstr_me rel_1d_cancer_me/ entry = entry_age RL; 
	ods output ParameterEstimates=rel_1d_cancer_me;
run;
data rel_1d_cancer_me; set rel_1d_cancer_me;
	if Parameter='fmenstr_me';
...
proc phreg data = use;
	class fmenstr_me  (ref='<=10') marriage (ref='married');
	model exit_age*melanoma_mal(0)=fmenstr_me marriage/ entry = entry_age RL; 
	ods output ParameterEstimates=marriage;
run;
data marriage; set marriage;
	if Parameter='fmenstr_me';
...
ods _all_ close;ods html;
*Combine and output to excel;
data confounder1_base_mal_fmenstr; 
	set 
		crude birthcohort
		education bmi_c_me physic_c_me 
		parity_me flb_age_c_me horm_ever_me
...
run;
data confounder1_base_mal_fmenstr; 
	set confounder1_base_mal_fmenstr
		(Keep= variable HazardRatio HRLowerCL HRUpperCL); 
		Parameter=log(HazardRatio);
run;
ods html file='C:\REB\AARP_HRTandMelanoma\Results\modelBuilding\confounder1_base_mal_fmenstr.xls' style=minimal;
proc print data= confounder1_base_mal_fmenstr; run;
ods _all_ close;ods html;
...
** oral bc duration;
proc phreg data = use;
	class fmenstr_me  (ref='<=10') oralbc_dur_c_me (ref='never');
	model exit_age*melanoma_mal(0)=fmenstr_me oralbc_dur_c_me/ entry = entry_age RL; 
	ods output ParameterEstimates=oralbc_dur_c_me;
run;
data oralbc_dur_c_me; set oralbc_dur_c_me;
