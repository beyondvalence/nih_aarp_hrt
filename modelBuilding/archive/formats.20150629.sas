...
proc format;
	...
	** menopause status recoded;
	value fmenstrfmt -9='missing' 0='<=10' 1='11-12' 2='13+';
	...
	value surgagefmt -9='missing' 1='<50' 2='50-54' 3='55+' 4='periods did not stop';
	...
	** menopause reason edit 20151512;
...
/* :::risk factors::: */
	...
	** Lacey - MHT encodings;
	...
	value l_etcurdur;
	value l_etcurrent;
	value l_etcurrentvr 4 = 'Other/Unknown HT' 3 = 'missing' 1 = 'Ever ET' 0 = 'No HT';
	...
	value l_sameyears 1 = 'Yes' 0 = 'No' -9='Missing';
